...
contract Courses {
    ...
    mapping(uint => EtablissementEnseignementSuperieur)tab_EES; 
    mapping(uint => Etudiant)tab_Etudiant;
    mapping(uint => Diplome)tab_Diplome;
    mapping(uint => Entreprise)tab_Entrepise;
    
    // Tâche 1 - DONE
    function creerUnCompteEtablissementSuperieur(uint _IdEES, string memory _NomEtablissement, string memory _Pays, string memory _Type, string memory _Adresse, string memory _Site_Web, uint _IdAgent) public {
    ...
    // Tâche 2 - DONE
    function creerProfilEtudiant(uint _IdEtudiant, string memory _Nom, string memory _Prenom, string memory _DateNaissance, string memory _Sexe, string memory _Nationalite, string memory _StatusCivil, string memory _Adresse, string memory _Courriel, string memory _Telephone, string memory _Session, string memory _SujetPFE, string memory _NomPrenom_MaitreDeStage, string memory _DateDebutStage, string memory _DateFinStage) public {
        ...
        tab_Etudiant[_IdEtudiant].NomPrenom_MaitreDeStage = _NomPrenom_MaitreDeStage;
    ...
    function ajouterDiplome(uint _IdDiplome, uint _IdEtudiant, string memory _NomEtablissementEnseignementSuperieur, uint _IdEES, string memory _TypeDiplome, string memory _Specialite, string memory _Mention, string memory _Date) public{
        ...
        tab_Diplome[_IdDiplome+_IdEtudiant].IdEdudiant = _IdEtudiant;
        tab_Diplome[_IdDiplome+_IdEtudiant].NomEtablissementEnseignementSuperieur = _NomEtablissementEnseignementSuperieur;
    ...
    // Tâche 4 - DONE
    function creerCompteEntreprise(uint _IdEntreprise, string memory _NomEntreprise, string memory _Secteur, string memory _DateCreation, string memory _ClassificationTaille, string memory _Pays, string memory _Adresse, string memory _Courriel, string memory _SiteWeb) public {
        ...
        tab_Entrepise[_IdEntreprise].ClassificationTaille = _ClassificationTaille;
    ...
    function evaluerEtudiantFinDeStage(uint _IdEtudiant, string memory _Evaluation) public {
        tab_Etudiant[_IdEtudiant].Evaluation = _Evaluation;
    }
    ...
    function verifierDiplomeCandidat(uint _IdEtudiant, uint _IdDiplome) public returns (bool) {
